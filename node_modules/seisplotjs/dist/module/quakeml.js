...
import { isNonEmptyStringArg, isStringArg, log, stringify, isNumArg, checkStringOrDate, isObject } from './util.js';
...
class Pick {
  ...
  static createFromXml(pickQML) {
    ...
    let channelCode = _grabAttribute(waveformIdEl, "channelCode"); // handle empty loc code, it can be missing
...
export { ANSS_CATALOG_NS, ANSS_NS, Arrival, BED_NS, IRIS_NS, Magnitude, Origin, Pick, QML_NS, Quake, UNKNOWN_MAG_TYPE, USGS_HOST, parseQuakeML, parseUtil };
//# sourceMappingURL=quakeml.js.map
