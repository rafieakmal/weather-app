...
import { PolesZeros } from './stationxml.js';
...
import Qty$1 from 'js-quantities';
...
const UNITS = {
  COUNT: new Qty$1('count'),
  METER: new Qty$1('m'),
  METER_PER_SECOND: new Qty$1('m/s'),
  METER_PER_SECOND_PER_SECOND: new Qty$1('m/s2')
};
/**
...
function convertToSacPoleZero(response) {
  ...
  const unitQty = new Qty$1(unit);
  let scaleUnit = new Qty$1(1, unit);
  let gamma = 0;
...
export { UNITS, applyFreqTaper, calcFreqTaper, calcResponse, calcResponseFromSacPoleZero, calc_A0, combine, convertToSacPoleZero, evalPoleZeroInverse, transfer, transferSacPZ, transferSacPZSegment };
